...
.method private getHttpUrlConnectionWithHeaders()Ljava/net/HttpURLConnection;
    ...
    invoke-direct {v4, v5}, Lcom/unity3d/services/core/request/NetworkIOException;-><init>(Ljava/lang/String;)V
    ...
    const-string v6, "Invalid url-protocol in url: "
...
.method public makeStreamRequest(Ljava/io/OutputStream;)J
    ...
    .line 121
    invoke-direct {p0}, Lcom/unity3d/services/core/request/WebRequest;->getHttpUrlConnectionWithHeaders()Ljava/net/HttpURLConnection;
    ...
    invoke-virtual {v1}, Lcom/unity3d/services/core/request/WebRequest$RequestType;->name()Ljava/lang/String;
    ...
    :try_start_1
    invoke-virtual {p0}, Lcom/unity3d/services/core/request/WebRequest;->getBody()Ljava/lang/String;
    ...
    .line 131
    invoke-virtual {p0}, Lcom/unity3d/services/core/request/WebRequest;->getQuery()Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/unity3d/services/core/request/WebRequest;->_responseHeaders:Ljava/util/Map;
    ...
    :cond_2
    iget-object v0, p0, Lcom/unity3d/services/core/request/WebRequest;->_progressListener:Lcom/unity3d/services/core/request/IWebRequestProgressListener;
    ...
    iget-wide v2, p0, Lcom/unity3d/services/core/request/WebRequest;->_contentLength:J

    iget v4, p0, Lcom/unity3d/services/core/request/WebRequest;->_responseCode:I

    iget-object v5, p0, Lcom/unity3d/services/core/request/WebRequest;->_responseHeaders:Ljava/util/Map;

    invoke-interface/range {v0 .. v5}, Lcom/unity3d/services/core/request/IWebRequestProgressListener;->onRequestStart(Ljava/lang/String;JILjava/util/Map;)V
    ...
    :cond_4
    :goto_1
    invoke-virtual {p0}, Lcom/unity3d/services/core/request/WebRequest;->isCanceled()Z
    ...
    iget-wide v4, p0, Lcom/unity3d/services/core/request/WebRequest;->_contentLength:J

    invoke-interface/range {v0 .. v5}, Lcom/unity3d/services/core/request/IWebRequestProgressListener;->onRequestProgress(Ljava/lang/String;JJ)V
    ...
    invoke-static {v0, v9}, Lcom/unity3d/services/core/log/DeviceLog;->exception(Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    invoke-direct {v0, v1}, Lcom/unity3d/services/core/request/NetworkIOException;-><init>(Ljava/lang/String;)V
...
.method public setProgressListener(Lcom/unity3d/services/core/request/IWebRequestProgressListener;)V
    .locals 0
    .param p1, "listener"    # Lcom/unity3d/services/core/request/IWebRequestProgressListener;
