...
.method static constructor <clinit>()V
    ...
    .line 20
    sput-boolean v0, Lcom/unity3d/services/core/connectivity/ConnectivityMonitor;->_wifi:Z

    .line 21
    sput v1, Lcom/unity3d/services/core/connectivity/ConnectivityMonitor;->_networkType:I
...
.method public static addListener(Lcom/unity3d/services/core/connectivity/IConnectivityListener;)V
    .locals 1
    .param p0, "listener"    # Lcom/unity3d/services/core/connectivity/IConnectivityListener;
...
.method public static connected()V
    ...
    .prologue
    .line 114
    sget v1, Lcom/unity3d/services/core/connectivity/ConnectivityMonitor;->_connected:I
    ...
    .line 129
    .local v0, "listener":Lcom/unity3d/services/core/connectivity/IConnectivityListener;
    :goto_0
    return-void

    .line 118
    .end local v0    # "listener":Lcom/unity3d/services/core/connectivity/IConnectivityListener;
    :cond_0
    ...
    .restart local v0    # "listener":Lcom/unity3d/services/core/connectivity/IConnectivityListener;
    :goto_1
    ...
    .line 124
    .restart local v0    # "listener":Lcom/unity3d/services/core/connectivity/IConnectivityListener;
    invoke-interface {v0}, Lcom/unity3d/services/core/connectivity/IConnectivityListener;->onConnected()V
    ...
    invoke-static {v1, v2, v3}, Lcom/unity3d/services/core/connectivity/ConnectivityMonitor;->sendToWebview(Lcom/unity3d/services/core/connectivity/ConnectivityEvent;ZI)V
...
.method public static connectionStatusChanged()V
    ...
    .line 152
    sget v5, Lcom/unity3d/services/core/connectivity/ConnectivityMonitor;->_connected:I
    ...
    sget-boolean v5, Lcom/unity3d/services/core/connectivity/ConnectivityMonitor;->_wifi:Z

    if-ne v4, v5, :cond_2

    sget v5, Lcom/unity3d/services/core/connectivity/ConnectivityMonitor;->_networkType:I
    ...
    .line 169
    :cond_2
    sput-boolean v4, Lcom/unity3d/services/core/connectivity/ConnectivityMonitor;->_wifi:Z
    ...
    .line 174
    sget-object v5, Lcom/unity3d/services/core/connectivity/ConnectivityEvent;->NETWORK_CHANGE:Lcom/unity3d/services/core/connectivity/ConnectivityEvent;

    invoke-static {v5, v4, v1}, Lcom/unity3d/services/core/connectivity/ConnectivityMonitor;->sendToWebview(Lcom/unity3d/services/core/connectivity/ConnectivityEvent;ZI)V
...
.method public static disconnected()V
    ...
    .end local v0    # "listener":Lcom/unity3d/services/core/connectivity/IConnectivityListener;
    :cond_0
    sput v3, Lcom/unity3d/services/core/connectivity/ConnectivityMonitor;->_connected:I
    ...
    .line 143
    .restart local v0    # "listener":Lcom/unity3d/services/core/connectivity/IConnectivityListener;
    invoke-interface {v0}, Lcom/unity3d/services/core/connectivity/IConnectivityListener;->onDisconnected()V
    ...
    invoke-static {v1, v3, v3}, Lcom/unity3d/services/core/connectivity/ConnectivityMonitor;->sendToWebview(Lcom/unity3d/services/core/connectivity/ConnectivityEvent;ZI)V
...
.method private static initConnectionStatus()V
    ...
    :goto_1
    sput-boolean v3, Lcom/unity3d/services/core/connectivity/ConnectivityMonitor;->_wifi:Z

    .line 102
    sget-boolean v3, Lcom/unity3d/services/core/connectivity/ConnectivityMonitor;->_wifi:Z
    ...
    sput v3, Lcom/unity3d/services/core/connectivity/ConnectivityMonitor;->_networkType:I
    ...
    .line 107
    :cond_3
    sput v4, Lcom/unity3d/services/core/connectivity/ConnectivityMonitor;->_connected:I
...
.method private static sendToWebview(Lcom/unity3d/services/core/connectivity/ConnectivityEvent;ZI)V
    .locals 7
    .param p0, "eventType"    # Lcom/unity3d/services/core/connectivity/ConnectivityEvent;
    .param p1, "wifi"    # Z
    ...
    .line 179
    sget-boolean v1, Lcom/unity3d/services/core/connectivity/ConnectivityMonitor;->_webappMonitoring:Z
