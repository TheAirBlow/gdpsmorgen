...
.method static constructor <clinit>()V
    ...
    .line 14
    sput-boolean v1, Lcom/unity3d/services/core/cache/CacheThread;->_ready:Z
    ...
    .line 19
    sput v2, Lcom/unity3d/services/core/cache/CacheThread;->_connectTimeout:I

    .line 20
    sput v2, Lcom/unity3d/services/core/cache/CacheThread;->_readTimeout:I

    .line 21
    sput v1, Lcom/unity3d/services/core/cache/CacheThread;->_progressInterval:I
...
.method public static declared-synchronized download(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;Z)V
    ...
    const-class v5, Lcom/unity3d/services/core/cache/CacheThread;

    monitor-enter v5

    :try_start_0
    sget-boolean v4, Lcom/unity3d/services/core/cache/CacheThread;->_ready:Z
    ...
    sget v6, Lcom/unity3d/services/core/cache/CacheThread;->_connectTimeout:I
    ...
    sget v6, Lcom/unity3d/services/core/cache/CacheThread;->_readTimeout:I
    ...
    sget v6, Lcom/unity3d/services/core/cache/CacheThread;->_progressInterval:I
    ...
    .line 74
    sget-object v4, Lcom/unity3d/services/core/cache/CacheThread;->_handler:Lcom/unity3d/services/core/cache/CacheThreadHandler;

    const/4 v6, 0x0

    invoke-virtual {v4, v6}, Lcom/unity3d/services/core/cache/CacheThreadHandler;->setCancelStatus(Z)V

    .line 75
    sget-object v4, Lcom/unity3d/services/core/cache/CacheThread;->_handler:Lcom/unity3d/services/core/cache/CacheThreadHandler;

    invoke-virtual {v4, v1}, Lcom/unity3d/services/core/cache/CacheThreadHandler;->sendMessage(Landroid/os/Message;)Z
    :try_end_1
...
.method private static init()V
    ...
    .prologue
    .line 24
    new-instance v1, Lcom/unity3d/services/core/cache/CacheThread;

    invoke-direct {v1}, Lcom/unity3d/services/core/cache/CacheThread;-><init>()V

    .line 25
    .local v1, "thread":Lcom/unity3d/services/core/cache/CacheThread;
    const-string v2, "UnityAdsCacheThread"

    invoke-virtual {v1, v2}, Lcom/unity3d/services/core/cache/CacheThread;->setName(Ljava/lang/String;)V

    .line 26
    invoke-virtual {v1}, Lcom/unity3d/services/core/cache/CacheThread;->start()V

    .line 28
    :goto_0
    sget-boolean v2, Lcom/unity3d/services/core/cache/CacheThread;->_ready:Z

    if-nez v2, :cond_0

    .line 30
    :try_start_0
    sget-object v3, Lcom/unity3d/services/core/cache/CacheThread;->_readyLock:Ljava/lang/Object;
